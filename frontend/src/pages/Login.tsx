...
const BRAND_FEATURES = [
  ...
  { icon: BarChart3, text: "Smart Performance Analytics", color: "#14b8a6" },
  { icon: Trophy, text: "Live Leaderboards", color: "#2dd4bf" },
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    className="w-full pl-4 pr-4 py-3 rounded-xl border text-white placeholder:text-white/25 focus:ring-2 focus:ring-teal-500/50 focus:border-teal-500/50 transition-all"
                    style={{
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="••••••••"
                    required
                    className="w-full pl-4 pr-12 py-3 rounded-xl border text-white placeholder:text-white/25 focus:ring-2 focus:ring-teal-500/50 focus:border-teal-500/50 transition-all"
                    style={{
                      background: "rgba(255,255,255,0.04)",
                      borderColor: "rgba(255,255,255,0.1)",
                    } as React.CSSProperties}
