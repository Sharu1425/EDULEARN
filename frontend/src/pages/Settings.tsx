          ...
          component: (
            <div className="flex items-center space-x-2">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-xl font-medium transition-all duration-300 ${mode === "professional" ? (colorScheme === "dark" ? "bg-gray-600 text-white" : "bg-gray-800 text-white") : colorScheme === "dark" ? "bg-gray-700 text-gray-300 hover:bg-gray-600" : "bg-gray-200 text-gray-700 hover:bg-gray-300"}`}
              >
                Professional
              </button>
            </div>
