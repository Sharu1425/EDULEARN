...
const ROLES: { id: Role; label: string; icon: React.FC<any>; desc: string; color: string }[] = [
  ...
  { id: "teacher", label: "Teacher", icon: BookOpen, desc: "Teach & inspire", color: "#14b8a6" },
  { id: "admin", label: "Admin", icon: Shield, desc: "Manage platform", color: "#2dd4bf" },
]
          ...
          >
            <h1 className="text-4xl font-black leading-tight text-white mb-4">
              ...
              <span className="bg-clip-text text-transparent"
                style={{ backgroundImage: "linear-gradient(135deg, #14b8a6, #2dd4bf)" }}>
                AI education
              </span>
            </h1>
